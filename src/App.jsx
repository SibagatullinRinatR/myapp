...
function App() {
    ...
    React.useEffect(() => {
        ...
        async function axiosData(){
            ...
            const tyrsData = await axios.get('https://63985bc6044fa481d69a6e2b.mockapi.io/tyrs')
            const cartData = await axios.get('https://63985bc6044fa481d69a6e2b.mockapi.io/cart')
            const favoritesData = await axios.get('https://63985bc6044fa481d69a6e2b.mockapi.io/favorites')
    ...
    const deleteItems=(id)=>{
        console.log(id);
        axios.delete(`https://63985bc6044fa481d69a6e2b.mockapi.io/cart/${id}`)
